...
import {Plus, User, LogOut, Menu, X, Shield} from 'lucide-react';
...
const Navbar = () => {
    ...
    const canAccessDashboard = user?.role === 'ADMIN' || user?.role === 'MODERATOR' || user?.role === 'SUPER_ADMIN';
        ...
        <nav
            ...
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-center h-14 sm:h-16">
                    {/* Logo */}
                        <Link to="/" onClick={closeMenu} className="flex items-center space-x-2 text-primary font-bold text-lg sm:text-xl shrink-0">
